...
<? endif; ?>
	...
	{
		$messCompare = $arParams['MESS_BTN_COMPARE'];
		if ($arResult["COMPARE_ISSET"] == "Y") {
			?>
			<div id="<?=$arResult['AREA_ID'].'_compare_link_cont'?>" class="product-item-compare-container-checked">
			<?
			$messCompare = GetMessage('COMPARE_ISSET');
		}
		else
		{
			?>
			<div id="<?=$arResult['AREA_ID'].'_compare_link_cont'?>" class="product-item-compare-container">
			<?
		}
			?>
			<div class="product-item-compare">
				<div class="checkbox">
					<label id="<?=$itemIds['COMPARE_LINK']?>">
						<input id="<?=$arResult['AREA_ID'].'_compare_link_box'?>" type="checkbox" data-entity="compare-checkbox">
						<span id="<?=$arResult['AREA_ID'].'_compare_link_span'?>" data-entity="compare-title"><?=$messCompare?></span>
					</label>
				</div>
			</div>
		</div>
